...
> Escribir un programa que muestre al usuario el catalogo de cursos y cuales de ellos desea tomar. Dependiendo de la decisión del usuario el programa debe rergresar el precio total con descuento sin IVA, el descuento aplicado y el precio total con descuento con IVA, considerando un impuesto IVA del 16%.
...
* Mantener la misma estructura y orden de las palabras para todos los casos de prueba, por ejemplo si usamos la palabra "verificar" al inicio de cada oración, está la deberemos mantener al inicio de todos, después procederemos con el objeto a verificar y por último con el restante de la oración. Esto ayudará a la comprendender más fácil el objetivo de los casos de prueba cuando se tienen más de 100, 1000, etc.
* Reutilizar los casos de prueba. En los 3 casos de preuba anteriores podemos preveer que los restantes para 2,3 y 4 cursos serán muy parecidos, por lo que se recomienda que en vez de escribir uno a uno los que faltan, se copie y peguen estos tres y sólo se modifiquen las palabras de interés.
...
- Verificar que si el alumno selecciona 2 cursos obtenga descuento del 10%.
- Verificar que si el alumno selecciona 3 cursos o 
- sas
